       ...
       <div>
         ...
         style={{
           ...
           <div className='max-width'>
            ...
            <button className='bg-[#E3B577] rancho-font font-bold px-5 py-2.5 text-[#242222] hover:bg-transparent hover:text-white border-2 border-transparent hover:border-white duration-300'>Learn More</button>
            </div>
            </div>
            </div> 
        </div>
